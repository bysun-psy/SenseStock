...
const SEED = [
  mk(1,'투명 시약병 500mL',5,'준비','선반','1',24,null,'PYREX 500mL','뚜껑 포함','2026-02', false, true),
  mk(2,'피펫 팁 박스',4,'준비','선반','2',18,5,'1000μL, 96개입','','2026-04'),
  mk(3,'정성여과지',4,'준비','선반','3',32,10,'110mm','','2026-03'),
  mk(4,'실리콘 호스',11,'준비','선반','4',6,2,'내경 8mm','','2026-01', false, true),
  mk(5,'전자저울 (정밀)',6,'준비','실험대 위','1',1,null,'AND HR-200','연간 교정 필요','2025-09', true, false),
  mk(6,'교반기',6,'준비','실험대 위','2',2,null,'IKA RH basic','','2025-10'),
  mk(7,'pH 미터',6,'준비','실험대 위','3',1,null,'Orion Star A211','','2025-11', true, false),
  ...
  mk(15,'항온수조',6,'준비','실험대 아래','6',1,null,'WiseBath WB-22','','2025-09', true, false),
